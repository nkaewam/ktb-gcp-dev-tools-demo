...
![UI Test Recording](./ui_test_walkthrough.webp)

## Key Observations

1. **Dynamic Scaling**: The DCA projection graph automatically adjusts its Y-axis as contribution amounts change (e.g., from ฿404k to ฿565k).
